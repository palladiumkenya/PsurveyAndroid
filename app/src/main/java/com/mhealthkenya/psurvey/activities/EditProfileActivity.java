...
public class EditProfileActivity extends AppCompatActivity {
    ...
    TextInputEditText etxt_first_name, etxt_lastname, etxt_phone_number, etxt_email;

    SearchableSpinner county_spinner, sub_county_spinner, facility_Spinner, designation_Spinner;
...
//        updateUserDetails();
        ...
        countyAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, new ArrayList<>());
        subCountyAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, new ArrayList<>());
        facilityAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, new ArrayList<>());

        county_spinner.setAdapter(countyAdapter);
        sub_county_spinner.setAdapter(subCountyAdapter);
        facility_Spinner.setAdapter(facilityAdapter);
    ...
    private void initialise(){
        ...
        county_spinner = (SearchableSpinner) findViewById(R.id.county_spinner);
        sub_county_spinner = (SearchableSpinner) findViewById(R.id.sub_county_spinner);
        facility_Spinner = (SearchableSpinner) findViewById(R.id.facility_Spinner);
...
//                        Log.e(TAG, error.getErrorBody());
    ...
    private void getFacilities() {
        ...
        facilityID = facilitySpinnerUtils.setupCountySpinner(countyAdapter,county_spinner,subCountyAdapter,sub_county_spinner,facilityAdapter,facility_Spinner,this);
    }

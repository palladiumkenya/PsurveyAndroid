                   ...
                   QuestionEntity question = questions.get(currentQuestionIndex);
                    ...
                    if (question.getQuestionType() == 1 && question.isRequired()) {
                        ...
                        if (numericEditText.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, numericEditText.getText().toString(),question.getQuestion());
                    ...
                    //datepicker none & not repeatable
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(),answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString(), question.getQuestion());
                    ...
                    //datepicker none & repeatable count2
                        ...
                        {
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString(), question.getQuestion());
                    ...
                    // datepicker none & repeatable count3
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString() + " ," + dobEditText3.getText().toString(), question.getQuestion());
                    ...
                    // datepicker none & repeatable count4
                        ...
                        {
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString().equals("") + " ," + dobEditText3.getText().toString().equals("") + " ," + dobEditText4.getText().toString().equals(""), question.getQuestion());
                    ...
                    //datepicker restrict future notrrepeat
                        ...
                        if (dobEditTextfuture.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString(), question.getQuestion());
                    ...
                    //datepicker restrict future repeat count 2
                        ...
                        if (dobEditTextfuture.getText().toString().equals("") || dobEditTextfuture2.getText().toString().equals("")) {
                            ...
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString() + " ," + dobEditTextfuture2.getText().toString(), question.getQuestion());
                    ...
                    //datepicker restrict future repeat count 3
                        ...
                        if (dobEditTextfuture.getText().toString().equals("") || dobEditTextfuture2.getText().toString().equals("") || dobEditTextfuture3.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString() + " ," + dobEditTextfuture2.getText().toString() + " ," + dobEditTextfuture3.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date non repeat
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 2
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 3
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 4
...

                        {
                           ...
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 5
...

                        {
                           ...
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 6
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString() + " ," + dobEditTextpast6.getText().toString(), question.getQuestion());
                       ...
                       // saveAnswersToDraft(savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString() + " ," + dobEditTextpast6.getText().toString(), question.getQuestion());
                        ...
                        if (radioButtonID == -1) {
                         ...
                         //   SaveAnswers(savedquestionnaireId, currentQuestionIndex, openText);
                           SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, String.valueOf(answerList.get(idx).getId()), question.getQuestion());
                        ...
                        SaveAnswers(question.getQuestionOrder(), question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, questionnaireId, currentQuestionIndex, openText, question.getQuestion());

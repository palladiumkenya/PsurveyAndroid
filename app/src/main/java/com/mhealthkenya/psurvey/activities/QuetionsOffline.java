    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        /*if (draftAnswers == null) {
            draftAnswers = new ArrayList<>(); // Assign your default value here
                   ...
                   QuestionEntity question = questions.get(currentQuestionIndex);
                    ...
                    if (question.getQuestionType() == 1 && question.isRequired()) {
                        ...
                        if (openTextEtxt.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex,  openTextEtxt.getText().toString(), question.getQuestion());
                        ...
                        if (numericEditText.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, numericEditText.getText().toString(),question.getQuestion());
                    ...
                    //datepicker none & not repeatable
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString(), question.getQuestion());
                    ...
                    //datepicker none & repeatable count2
                        ...
                        {
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString(), question.getQuestion());
                    ...
                    // datepicker none & repeatable count3
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString() + " ," + dobEditText3.getText().toString(), question.getQuestion());
                    ...
                    // datepicker none & repeatable count4
                        ...
                        {
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString().equals("") + " ," + dobEditText3.getText().toString().equals("") + " ," + dobEditText4.getText().toString().equals(""), question.getQuestion());
                    ...
                    // datepicker none & repeatable count5
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString().equals("") + " ," + dobEditText3.getText().toString().equals("") + " ," + dobEditText4.getText().toString().equals("") + " ," + dobEditText5.getText().toString().equals(""), question.getQuestion());
                    ...
                    // datepicker none & repeatable count6
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditText.getText().toString() + " ," + dobEditText2.getText().toString().equals("") + " ," + dobEditText3.getText().toString().equals("") + " ," + dobEditText4.getText().toString().equals("") + " ," + dobEditText5.getText().toString().equals("") + " ," + dobEditText6.getText().toString().equals(""), question.getQuestion());
                    ...
                    //datepicker restrict future notrrepeat
                        ...
                        if (dobEditTextfuture.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString(), question.getQuestion());
                    ...
                    //datepicker restrict future repeat count 2
                        ...
                        if (dobEditTextfuture.getText().toString().equals("") || dobEditTextfuture2.getText().toString().equals("")) {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString() + " ," + dobEditTextfuture2.getText().toString(), question.getQuestion());
                    ...
                    //datepicker restrict future repeat count 3
                        ...
                        if (dobEditTextfuture.getText().toString().equals("") || dobEditTextfuture2.getText().toString().equals("") || dobEditTextfuture3.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString() + " ," + dobEditTextfuture2.getText().toString() + " ," + dobEditTextfuture3.getText().toString(), question.getQuestion());
                    ...
                    //datepicker restrict future repeat count 4
                        ...
                        if (dobEditTextfuture.getText().toString().equals("") || dobEditTextfuture2.getText().toString().equals("") || dobEditTextfuture3.getText().toString().equals("") || dobEditTextfuture4.getText().toString().equals("")) {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString() + " ," + dobEditTextfuture2.getText().toString() + " ," + dobEditTextfuture3.getText().toString() + " ," + dobEditTextfuture4.getText().toString(), question.getQuestion());
                    ...
                    //datepicker restrict future repeat count 5
                        ...
                        if (dobEditTextfuture.getText().toString().equals("") || dobEditTextfuture2.getText().toString().equals("") || dobEditTextfuture3.getText().toString().equals("") || dobEditTextfuture4.getText().toString().equals("") || dobEditTextfuture5.getText().toString().equals("")) {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextfuture.getText().toString() + " ," + dobEditTextfuture2.getText().toString() + " ," + dobEditTextfuture3.getText().toString() + " ," + dobEditTextfuture4.getText().toString() + " ," + dobEditTextfuture5.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date non repeat
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 2
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 3
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 4
...

                        {
                           ...
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 5
...

                        {
                           ...
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date  repeat count 6
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString() + " ," + dobEditTextpast6.getText().toString(), question.getQuestion());
                       ...
                       // saveAnswersToDraft(savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString() + " ," + dobEditTextpast6.getText().toString(), question.getQuestion());
                        ...
                        if (radioButtonID == -1) {
                         ...
                         //   SaveAnswers(savedquestionnaireId, currentQuestionIndex, openText);
                           SaveAnswers(question.getQuestionOrder(), surveyUniqueID, savedquestionnaireId, currentQuestionIndex, String.valueOf(answerList.get(idx).getId()), question.getQuestion());
                        ...
                        SaveAnswers(question.getQuestionOrder(), surveyUniqueID, questionnaireId, currentQuestionIndex, openText, question.getQuestion());
...
//                    Toast.makeText(context, String.valueOf(multiAnswerList), Toast.LENGTH_SHORT).show();
   ...
   /* @Override
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // Save the currentQuestionIndex and draftAnswers to the bundle
        outState.putInt("currentQuestionIndex", currentQuestionIndex);
        outState.putParcelableArrayList("draftAnswers", new ArrayList<>(draftAnswers));
    }

    @Override
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        super.onRestoreInstanceState(savedInstanceState);
        // Restore the currentQuestionIndex and draftAnswers from the bundle

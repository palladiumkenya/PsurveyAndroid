    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        try {
            ...
            List<ConsentID> consentID = SurveyID.findWithQuery(ConsentID.class, "SELECT *from ConsentID ORDER BY id DESC LIMIT 1");
            if (consentID.size()==1){
                for (int x=0; x<consentID.size(); x++) {
                    savedgeneratedId = consentID.get(x).getGeneratedID();
                    Log.d("GeneratedIDS", String.valueOf(savedgeneratedId));
                   ...
                   QuestionEntity question = questions.get(currentQuestionIndex);
                    ...
                    if (question.getQuestionType() == 1 && question.isRequired()) {
                        ...
                        if (openTextEtxt.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(), savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(),  openTextEtxt.getText().toString(), question.getQuestion());
                        ...
                        if (numericEditText.getText().toString().equals("")) {
                           ...
                           SaveAnswers(question.getQuestionOrder(),savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(), numericEditText.getText().toString(),question.getQuestion());
                    ...
                    //datepicker none & not repeatable
                        ...
                        {
                            SaveAnswers(question.getQuestionOrder(), savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(),answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(), dobEditText.getText().toString(), question.getQuestion());
                    ...
                    //datepicker none & repeatable count2
                        ...
                        {
                           SaveAnswers(question.getQuestionOrder(),savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(), dobEditText.getText().toString() + " ," + dobEditText2.getText().toString(), question.getQuestion());
                    ...
                    //restrict past date non repeat
...

                        {
                            ...
                            SaveAnswers(question.getQuestionOrder(),savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(), dobEditTextpast.getText().toString(), question.getQuestion());
                       ...
                       // saveAnswersToDraft(savedquestionnaireId, currentQuestionIndex, dobEditTextpast.getText().toString() + " ," + dobEditTextpast2.getText().toString() + " ," + dobEditTextpast3.getText().toString() + " ," + dobEditTextpast4.getText().toString() + " ," + dobEditTextpast5.getText().toString() + " ," + dobEditTextpast6.getText().toString(), question.getQuestion());
                        ...
                        if (radioButtonID == -1) {
                         ...
                         //   SaveAnswers(savedquestionnaireId, currentQuestionIndex, openText);
                           SaveAnswers(question.getQuestionOrder(),savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(), String.valueOf(answerList.get(idx).getId()), question.getQuestion());
                        ...
                        SaveAnswers(question.getQuestionOrder(), savedgeneratedId, question.getQuestionType(),question.isRequired(), question.getDateValidation(), question.isRepeatable(), answerEntity.getId(), surveyUniqueID, savedquestionnaireId, question.getId(), String.valueOf(multiAnswerList), question.getQuestion());
